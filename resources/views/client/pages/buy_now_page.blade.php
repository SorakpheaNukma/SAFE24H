...
@section('content')
    ...
    <main class="container mb-5">
        <!-- Back Button -->
        <div class="container_back mb-3" style="display: flex; align-items: center; padding-left: 12px; gap: 8px;">
    ...
    <script>
        ...
        <div class="container mb-3">
            <div class="row">
                <div class="col-12 d-flex flex-md-row flex-column justify-content-md-between">
                    <h6 class="fw-bold fs-5">ព័ត៌មានទីតាំងទំនាក់ទំនង</h6>
                    <h6 id="id-change-address" class="text-primary" style = color:blue>កែសម្រួល</h6>
                </div>
                <div class="col-md-12 col-10 mt-2">
                    <div class="container">
                        <p class="fw-semibold mb-1 fs-6"> {{ Auth::user()->username }}</p>
                        <p class="mb-1 fs-6"> {{ Auth::user()->phone_number }}</p>
        ...
        <div class="container mt-2 mb-3">
            ...
            <div class="row">
                <div class="col-12">
                    <h6 class="fw-bold fs-5">បញ្ជីទំនិញ</h6>
                </div>
        ...
        <div class="container mt-2 mb-3">
            <div class="row">
                <div class="col-12">
                    <h6 class="fw-bold fs-5">ជម្រើសការទូរទាត់ប្រាក់</h6>
                </div>
        ...
        <div class="container mt-2 p-3 mb-3">
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    <h6 class="fw-bold fs-5">បញ្ជាក់ការទូរទាត់ប្រាក់</h6>
                </div>
                <div class="col-12 p-3 text-black rounded" style="background-color: white;">
                    ...
                    <div class="row">
                        <div class="col-6 fw-bold fs-5">សរុបរួម</div>
                        <div class="col-6 text-end fw-bold fs-5" id="total-payment">$0.00</div>
                    </div>
                </div>
            </div>
        </div>
